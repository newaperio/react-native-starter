...
print_header "React Native Starter"
...
latest_version=$(
  curl \
    ...
    https://api.github.com/repos/newaperio/react-native-starter/releases/latest |
    jq -r ".tag_name"
)
...
print_info "Compare view" \
  "https://github.com/newaperio/react-native-starter/compare/$current_version...$latest_version"
print_info "Changelog" \
  "https://github.com/newaperio/react-native-starter/blob/$latest_version/CHANGELOG.md"
